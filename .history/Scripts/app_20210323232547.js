...
((core) =>
{
    ...
    function toggleTaskList()
    {
      ...
      if(sessionStorage.getItem("user"))
      {
        // swap out the login link for logout
        $("#task-List").html(
        `<a id="logout" class="nav-link" aria-current="page"><i class="fas fa-sign-out-alt"></i>task-list</a>`
        );
        ...
        $(`<li class="nav-item">
        <a id="contact-list" class="nav-link" aria-current="page"><i class="fas fa-users fa-lg"></i> Task List</a>
      ...
      else
      {
        // swap out the login link for logout
        $("#task-list").html(
          `<a id="login" class="nav-link" aria-current="page"><i class="fas fa-sign-in-alt"></i> Task List</a>`
          );
      }
